        ...
        <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen '>
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                <div className='flex items-center gap-2'>
                    ...
                    <input type='text' placeholder='Search...' id='searchTerm' className='border rounded-lg  p-3 w-full' value={setSidebardata.searchTerm} onChange={handleChange}/>
                </div>
                ...
                <div className='flex gap-2 items-center'>
                    ...
                    <div className='flex gap-2'>
                        <select onChange={handleChange} id='sort_order' className='border rounded-lg p-2 bg-gray-200'>
                ...
                <button className='p-3 border rounded-lg text-white bg-slate-700 hover:opacity-95'>SEARCH</button>
            </form>
        </div>
        ...
        <div className='flex-1'>
            ...
            <div className='flex p-7 flex-wrap gap-4'>
              {!loading && listings.length===0 && (
                <p className='text-xl text-center w-full text-slate-700'>No listing found!</p>
              )}
              ...
              {showMore && 
              (
                <button onClick={onShowMoreClick()} className='text-green-700 p-7 w-full text-center hover:underline'>Show More</button>
              )}
